...
class AnnotationsSmokeTest {
  ...
  @Screen(ScreenA::class) fun screenFun(route: ScreenA) = Unit

  @Screen(route = ScreenA::class) fun screenFunExplicit(route: ScreenA) = Unit

  @Dialog(ScreenB::class) fun dialogFun(route: ScreenB) = Unit

  @BottomSheet(ScreenC::class) fun bottomSheetFun(route: ScreenC) = Unit

  @FullscreenModal(ScreenD::class) fun fullscreenModalFun(route: ScreenD) = Unit
