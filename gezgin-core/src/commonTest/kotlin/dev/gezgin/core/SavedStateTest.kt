...
class SavedStateTest {
    ...
    @Test fun pendingDeliveredResultSurvivesProcessDeath() = kotlinx.coroutines.test.runTest {
        ...
        val n2 = RawNavigator(Feed, testTopology, onRootBack = {}, json = Json, restored = json.decodeFromString(SavedState.serializer(), saved))
    ...
    @Test fun polymorphicResultSurvivesRestore_withModuleAwareJson() = runTest {
        ...
        val n2 = RawNavigator(Feed, testTopology, onRootBack = {}, json = json,
    ...
    @Test fun restoreFailsWhenValuePayloadHasNoSerializer() {
        ...
        val error = assertFailsWith<IllegalArgumentException> {
            RawNavigator(Feed, missingResultSerializerTopology, onRootBack = {}, json = json, restored = saved)
        }
