 ...
 * nothing" (the basis of the §9 cascade): a graph interface may override this property to supply
 * its own group-wide transition; routes that implement it inherit the graph's value through
 * Kotlin's interface property-override chain unless they have their own override (the screen>graph
 * cascade comes FOR FREE — no extra code). The remaining app-level step
