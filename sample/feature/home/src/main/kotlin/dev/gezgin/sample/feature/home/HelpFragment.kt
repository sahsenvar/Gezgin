...
// Brownfield Fragment interop: Fragment hiçbir Gezgin arayüzü implement etmez ve parametreli ctor'u
// YOK
// (framework no-arg ctor + Bundle ile yeniden yaratır). Route/navigator gezginArgs/gezginNav ile
// enjekte edilir.
