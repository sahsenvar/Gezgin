...
Consumer fixture `includeBuild`, composite substitution, `projectDir` veya başka source dependency kullanmaz. Gezgin root exact `0.1.0-alpha05` artefaktını önce Maven Local'a publish eder; fixture yalnız bu pinli koordinatı çözer.
