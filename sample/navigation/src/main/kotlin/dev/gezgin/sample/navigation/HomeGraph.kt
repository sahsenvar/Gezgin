...
sealed interface HomeGraph : Route {
    ...
    // @FullscreenModal: FullscreenModalContract'ın usePlatformDefaultWidth'i YOK (adapter'da sabit false)
    // → DialogContract'tan ayrı render kontratı.
    ...
    // Route declaration'ı :sample:navigation'da, @FragmentScreen HelpFragment ise :feature:home'da —
    // codegen route paketini Fragment paketinden değil, declaration'dan okur (cross-module interop).
    @BackTo(DashboardScreenRoute::class)
    @Serializable
