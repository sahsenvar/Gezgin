...
/**
 * Task 2.0 spike gate. Two things must hold for every later `:gezgin-processor` task to be able
 * to build on [CompileHarness]:
 *  1. A source implementing `dev.gezgin.core.Route` compiles OK — proves `inheritClassPath`
 *     actually exposes `:gezgin-core`'s jvm classes to the in-memory compilation.
