...
/**
 * `NavigatorCodegen.navigatorX` (türetilmiş "X" adı) —
 * `-ScreenRoute`/`-DialogRoute`/`-BottomSheetRoute` konvansiyonunun üretilen adları
 * DEĞİŞTİRMEDİĞİNİ (Screen/Flow bileşik olarak atılır, Dialog/BottomSheet korunur) ve eski
 * davranışın (tek sonek) regresyona uğramadığını kilitler.
 */
