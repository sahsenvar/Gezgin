...
/**
 * Emits `@file:OptIn(GezginInternalApi::class)` on a generated file. Generated code is the intended
 ...
 * `bindGezgin`, `@GezginNavigatorFor`, `GezginTestNavigator.raw`), so the whole generated file opts
 * in.
 */
