        ...
        componentSelection {
            all {
                if (
                    ...
                    reject("The Android consumer must resolve the AndroidX Navigation 3 and lifecycle Navigation 3 families.")
                }
            }
        }
    }
...
dependencies {
    ...
    implementation("dev.gezgin:gezgin-mvi:0.1.0-alpha05")
